...
public class BichosFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonCao = view.findViewById(R.id.buttonCachorro);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.buttonCachorro) {
            mediaPlayer = MediaPlayer.create(getActivity(), R.raw.dog);
            tocarSom();
        }
        else if (view.getId() == R.id.buttonGato) {
            mediaPlayer = MediaPlayer.create(getActivity(), R.raw.cat);
            tocarSom();
        }
        else if (view.getId() == R.id.buttonLeao) {
            mediaPlayer = MediaPlayer.create(getActivity(), R.raw.lion);
            tocarSom();
        }
        else if (view.getId() == R.id.buttonMacaco) {
            mediaPlayer = MediaPlayer.create(getActivity(), R.raw.monkey);
            tocarSom();
        }
        else if (view.getId() == R.id.buttonOvelha) {
            mediaPlayer = MediaPlayer.create(getActivity(), R.raw.sheep);
            tocarSom();
        }
        else if (view.getId() == R.id.buttonVaca) {
